...
// Define la anotación personalizada PersistenceAdapter
...
public @interface PersistenceAdapter {
    ...
    String value() default ""; // Atributo para proporcionar un nombre descriptivo al adaptador de persistencia
